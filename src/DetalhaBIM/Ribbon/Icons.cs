...
namespace DetalhaBIM.Ribbon
{
    ...
    public static class Icons
    {
        ...
        private static readonly Dictionary<string, Glyph> Glyphs = new Dictionary<string, Glyph>
        {
            ...
            ["cota-alinhada"] = new Glyph("M3.5,13.5 L13.5,3.5 M1.8,11.8 L5.2,15.2 M11.8,1.8 L15.2,5.2", "M8,20 L20,8 L22.8,10.8 L10.8,22.8 Z"),
            ["cotas-3d"] = new Glyph("M12,9 L19.5,12.5 V19.5 L12,23 L4.5,19.5 V12.5 Z M4.5,12.5 L12,16 L19.5,12.5 M12,16 V23 M4.5,8 L12,4.5 M4.5,6.2 V9.8 M12,2.7 V6.3"),
            ...
            ["rodapes"] = new Glyph("M3,3 H21 V21 H3 Z M9,21 V8 H15 V21", "M3,16.5 H9 V21 H3 Z M15,16.5 H21 V21 H15 Z"),
            ["paginacao"] = new Glyph("M3,3 H21 V21 H3 Z M3,12 L12,3 L21,12 L12,21 Z M3,3 L21,21 M21,3 L3,21"),
            ["acabamentos"] = new Glyph("M4,3.5 H17 V9.5 H4 Z M17,6.5 H20.5 V13 H11 V15.5", "M9.3,15.5 H12.7 V22.5 H9.3 Z"),
            ["marcenaria"] = new Glyph("M3,4 H21 V19.5 H3 Z M3,9.5 H21 M12,9.5 V19.5 M5,19.5 V22 M19,19.5 V22", "M10,6 H14 V7.6 H10 Z" + Circle(9.5, 14.5, 1.3) + Circle(14.5, 14.5, 1.3)),
            ["locacao"] = new Glyph("M2.5,3 V21 M21.5,3 V21 M2.5,12 H8 M16,12 H21.5 M8,8 H16 V16 H8 Z"),
            ["levantamento"] = new Glyph("M5,2.5 H19 V21.5 H5 Z M8,5.5 H16 V9.5 H8 Z", Circle(9, 13.5, 1.4) + Circle(12, 13.5, 1.4) + Circle(15, 13.5, 1.4) + Circle(9, 18, 1.4) + Circle(12, 18, 1.4) + Circle(15, 18, 1.4)),
